...
public class DetailedHistoryView extends javax.swing.JFrame {
    ...
    public DetailedHistoryView(DetailedHistoryController controller, String sessionKey) {
        ...
        initComponents();
        totalHistoryTable.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        monthlyHistoryTable.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
    }
    ...
    private void initComponents() {
        ...
        totalHistoryTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Monto", "Con intereses", "Creada", "Registrada por"
            }
        ) {
        ...
        if (totalHistoryTable.getColumnModel().getColumnCount() > 0) {
            totalHistoryTable.getColumnModel().getColumn(0).setResizable(false);
            totalHistoryTable.getColumnModel().getColumn(1).setResizable(false);
            totalHistoryTable.getColumnModel().getColumn(2).setResizable(false);
            totalHistoryTable.getColumnModel().getColumn(3).setResizable(false);
        }
        ...
        if (monthlyHistoryTable.getColumnModel().getColumnCount() > 0) {
            monthlyHistoryTable.getColumnModel().getColumn(0).setResizable(false);
            monthlyHistoryTable.getColumnModel().getColumn(1).setResizable(false);
        }
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(tabs, javax.swing.GroupLayout.PREFERRED_SIZE, 950, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        goBackButton.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    Logger.getLogger(DetailedHistoryView.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
            updated = true;
        ...
        for (int i = finalAmounts.size() - 1; i >= 0; i--) {
            if (finalAmounts.get(i) != null) {
                dcd.setValue(
                        ...
                        getDateInfo(controlDates.get(i))
                );
            } else {
                dcd.setValue(
                        0,
    ...
    private String getDateInfo(String controlDate) {
        String month = MainController.getMonthName(controlDate.substring(5, 7));
        String year = controlDate.substring(0, 4);
        return month + ", " + year;
    }
    ...
    public void setMonthlyHistoryTableModel() {
        ...
        for(int i = 0; i < controller.getMonthlyAmount().size(); i++) {
            ...
            objectMatrix[i][1] = MainController.getMonthName(controller.getMonthlyDates().get(i).substring(5, 7)) +
                    ", " +
                    MainController.parseToViewDate(controller.getMonthlyDates().get(i)).substring(3);
        }
    ...
    public void setTotalHistoryTable() throws IOException, ParseException {
        MainController.authenticate(sessionKey);
        
        Object[][] objectMatrix;
        List<Debt> debts;
        debts = controller.getCurrentClient().getDebts();

        objectMatrix = new Object[debts.size()][4];
        int debtsSize = debts.size();
        for (int i = 0; i < debtsSize; i++) {
            objectMatrix[i][0] = "$ " + MainController.formatAmount(debts.get(debtsSize - (i + 1)).getAmount());
            objectMatrix[i][1] = "$ " + MainController.formatAmount(debts.get(debtsSize - (i + 1)).getAmountPlusInterest());
            objectMatrix[i][2] = MainController.parseToViewDate(debts.get(debtsSize - (i + 1)).getCreationDate());
            objectMatrix[i][3] = debts.get(debtsSize - (i + 1)).getCreatedBy();
        }
        ...
        totalHistoryTable.getTableHeader().setResizingAllowed(false);
        totalHistoryTable.getTableHeader().setReorderingAllowed(false);
        totalHistoryTable.setModel(model);

        totalHistoryTable.getColumnModel().getColumn(2).setPreferredWidth(30);
        totalHistoryTable.getColumnModel().getColumn(3).setPreferredWidth(30);
